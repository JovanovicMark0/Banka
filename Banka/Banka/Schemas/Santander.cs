...
namespace Banka.Schemas
{
    public class Santander : Banka
    {
        ...
        {
            //Kreditne aplikacije korisnika za Banku Santander
            ...
            if (kreditneAplikacijeList.Count() > 0)
            {
                ...
                {
                    if (kreditnaAplikacija.klijent.godineRadnogStaza >= 5 && odnosPlateIRateCalculator(kreditnaAplikacija.brojMesecnihRata, kreditnaAplikacija.iznosKredita, kreditnaAplikacija.brojMesecnihRata))
                    {
